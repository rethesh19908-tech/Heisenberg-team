...
# =========================================================
# CSV VALIDATION & AUTO-CATEGORIZATION
# =========================================================
...
def _prepare_expenses(df):
    """Common cleanup: fill in category if needed, parse dates, keep only
    expense rows (amount < 0), and flip them positive so they're easier
    to sum and chart."""
